                    ...
                    ->tabs([
                        ...
                        Tab::make('Condomínio/Associação')
                            ...
                            ->schema([
                                Section::make('Dados específicos')
                                    ...
                                    ->schema([
                                        ...
                                        TextInput::make('residential_count')
                                            ...
                                            ->visible(fn (Get $get): bool => ($get('issuer_type')?->value ?? $get('issuer_type')) === IssuerTypeEnum::CONDOMINIO->value
                                                && ($get('condominium_type')?->value ?? $get('condominium_type')) === CondominiumTypeEnum::MISTO->value)
                                            ->dehydrated(fn (Get $get): bool => ($get('issuer_type')?->value ?? $get('issuer_type')) === IssuerTypeEnum::CONDOMINIO->value
                                                && ($get('condominium_type')?->value ?? $get('condominium_type')) === CondominiumTypeEnum::MISTO->value)
                                            ->placeholder('Ex: 80')
                                            ->columnSpan(3),
                                ...
                                Section::make('Unidades do Condomínio')
