                                            ...
                                            ->state(function ($record): string {
                                                ...
                                                if ($total === 0) {
                                                    ...
                                                    foreach ($validacoes as $v) {
                                                        $severityColor = match ($v->severidade->value) {
                                                            'erro' => 'danger', 'aviso' => 'warning', default => 'info'
                                                        };
                                                        $statusColor = match ($v->status->value) {
                                                            'pendente' => 'warning', 'confirmado' => 'success', default => 'gray'
                                                        };
