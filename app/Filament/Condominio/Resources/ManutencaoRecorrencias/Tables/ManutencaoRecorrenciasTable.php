...
namespace App\Filament\Condominio\Resources\ManutencaoRecorrencias\Tables;
...
class ManutencaoRecorrenciasTable
{
        ...
        return $table
            ...
            ->filters([
                SelectFilter::make('frequencia')
                    ->label('Frequência')
                    ->options(ManutencaoFrequenciaEnum::class)
                    ->native(false),
            ...
            ->emptyStateHeading('Nenhuma recorrência encontrada')
            ->emptyStateDescription('Comece criando seu primeiro template de recorrência.')
            ->striped()
            ->paginated([10, 25, 50]);
    }
}
