...
class ImportWizardAction extends Action
{
    ...
    protected function setUp(): void
    {
        ...
        $modalWidthConfig = Config::get('import-wizard.modal_width', Width::Full);

        $this->modalSubmitAction(false);
        $this->modalCancelAction(false);
        $this->label(__('filament-import-wizard.import_wizard.label'));
        $this->modalHeading(__('filament-import-wizard.import_wizard.heading'));
        $this->modalWidth($modalWidthConfig);
        $this->closeModalByClickingAway(false);
        $this->modalContent(fn () => View::make('filament.modals.import-wizard', [
