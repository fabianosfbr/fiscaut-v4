...
class DownloadXmlPdfNfceEmLoteActionJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        try {
            ...
            $secureDownload = SecureDownload::create([
                'user_id' => $this->userId,
                'file_path' => $filename,
                'file_name' => 'nfce_'.now()->format('Ymd_His').'.zip',
            ...
            Log::error('Error in DownloadXmlPdfNfceEmLoteActionJob', [
                'error' => $e->getMessage(),
