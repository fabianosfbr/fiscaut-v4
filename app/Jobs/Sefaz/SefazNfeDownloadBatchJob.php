...
class SefazNfeDownloadBatchJob implements ShouldQueue
{
    ...
    public function handle(): void
    {
        try {
            ...
            Bus::batch($jobs)
                ->name('Processamento de documentos SEFAZ - Issuer ' . $this->issuer->id)
                ->allowFailures()
                ...
                ->catch(function (\Throwable $e) {
                    ...
                    Log::error('Erro no processamento em lote de documentos SEFAZ: ' . $mensagemErro);
                ...
                ->finally(function () use ($totalFiles) {
                    ...
                    Log::info('Processamento em lote de documentos SEFAZ concluído. Total de arquivos na consulta: ' . $totalFiles);
                })
                ->dispatch();
        } catch (\Throwable $e) {
            Log::error('Falha no processamento em lote de documentos SEFAZ: ' . $e->getMessage());
            throw $e;
        }
    }
}
