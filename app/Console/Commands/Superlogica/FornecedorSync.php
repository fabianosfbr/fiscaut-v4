...
class FornecedorSync extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'app:fornecedor-sync {--tenant= : ID do emitente para download específico}';
     ...
     * @var string
     */
    protected $description = 'Sincroniza os fornecedores do Superlogica com o banco de dados';
