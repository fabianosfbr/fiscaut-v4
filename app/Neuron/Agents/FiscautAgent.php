    ...
    protected function instructions(): string
    {
        return (string) new SystemPrompt(
            ...
            output: [
                ...
                '8. Quando trouxer dados, contextualize de forma humana. Em vez de só listar, comente brevemente (ex: "Achei 3 grupos, olha só:").',
                '9. Use formatação markdown quando ajudar na leitura (tabelas, listas), mas sem exagero.',
                '10. Ao criar ou editar algo, confirme o que foi feito de forma breve e positiva.',
                '11. Se o contexto da conversa já deixa claro o que o usuário quer, aja sem pedir confirmação desnecessária.',
            ],
            toolsUsage: [
