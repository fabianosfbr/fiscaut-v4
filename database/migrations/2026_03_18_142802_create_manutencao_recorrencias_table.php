...
return new class extends Migration
{
    ...
    {
        Schema::create('manutencao_recorrencias', function (Blueprint $table) {
            $table->id();
            $table->foreignId('issuer_id')->constrained('issuers')->cascadeOnDelete();
            $table->foreignId('tipo_manutencao_id')->constrained('tipos_manutencao')->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('manutencao_recorrencias');
    }
};
