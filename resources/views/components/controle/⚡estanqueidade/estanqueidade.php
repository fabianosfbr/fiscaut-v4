    ...
    public function table(Table $table): Table
    {
        return $table
            ->query(fn(): Builder => IssuerControlModel::query()
                ...
                ->where('control_type', ControlTypeEnum::ESTANQUEIDADE))
            ->defaultSort('created_at', 'desc')
            ->heading('Estanqueidades cadastradas')
            ->emptyStateHeading('Nenhuma Estanqueidade cadastrada')
            ->searchDebounce(750)
            ->columns([
    ...
    public function updateOrCreate($data)
    {
        ...
        IssuerControlModel::updateOrCreate(
            ...
            [
                ...
                'control_type' => ControlTypeEnum::ESTANQUEIDADE,
                'value' => [
