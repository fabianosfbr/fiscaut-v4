    ...
    public function table(Table $table): Table
    {
        return $table
            ->query(fn (): Builder => IssuerControlModel::query()
                ...
                ->where('control_type', ControlTypeEnum::BRIGADA_INCENDIO))
            ->defaultSort('created_at', 'desc')
            ->heading('Brigadas de Incêndio cadastradas')
            ->emptyStateHeading('Nenhuma brigada de incêndio cadastrada')
            ->searchDebounce(750)
            ->columns([
    ...
    public function updateOrCreate($data)
    {
        ...
        IssuerControlModel::updateOrCreate(
            ...
            [
                ...
                'control_type' => ControlTypeEnum::BRIGADA_INCENDIO,
                'value' => [
