    ...
    public function table(Table $table): Table
    {
        return $table
            ->query(fn (): Builder => IssuerControlModel::query()
                ...
                ->where('control_type', ControlTypeEnum::PISCINA))
            ->defaultSort('created_at', 'desc')
            ->heading('Piscinas cadastradas')
            ->emptyStateHeading('Nenhuma piscina cadastrada')
            ->searchDebounce(750)
            ->columns([
    ...
    public function updateOrCreate($data)
    {
        ...
        IssuerControlModel::updateOrCreate(
            ...
            [
                ...
                'control_type' => ControlTypeEnum::PISCINA,
                'value' => [
