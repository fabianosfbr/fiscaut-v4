...
new class extends Component implements HasActions, HasSchemas
{
    ...
    public function save(): void
    {
        ...
        try {
            ...
            Log::error('Erro ao salvar Acumuladores CTe NFe Entrada: '.$e->getMessage());
    ...
    private function showSuccessNotification(): void
    {
        Notification::make()
            ->title('Sucesso')
            ->body('Acumuladores CTe NFe Entrada salvos com sucesso!')
            ->success()
            ->send();
    }
    ...
    private function showErrorNotification(string $message): void
    {
        Notification::make()
            ->title('Erro')
            ->body('Erro ao salvar Acumuladores CTe NFe Entrada: '.$message)
            ->danger()
            ->send();
    }
};
