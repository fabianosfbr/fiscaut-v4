<x-filament::page>
   ...
   <x-filament::section heading="Sobre o processamento em segundo plano" class="mt-6">
        <p class="text-gray-500 dark:text-gray-400">
            Os arquivos XML são processados em segundo plano, permitindo que você continue usando o sistema enquanto o processamento ocorre.
            Você pode acompanhar o progresso das importações na página de <a href="#" class="text-primary-600 hover:text-primary-500 dark:text-primary-500 dark:hover:text-primary-400">Histórico de Importações</a>.
        </p>
